...
![A Gaussian point cloud stretched, rotated, and shifted in 2D]({{ '/assets/images/pca-gaussian-cloud.png' | relative_url }})
...
![Principal axes and the 1- and 2-sigma ellipses of the Gaussian cluster]({{ '/assets/images/pca-principal-axes-ellipses.png' | relative_url }})
...
![Data projected onto the principal components]({{ '/assets/images/pca-projected-components.png' | relative_url }})
