...
$$\begin{aligned}
\log \binom{N}{x} &= \log \frac{N!}{x!\,(N-x)!} \\
&= \log N! - \log x! - \log (N-x)! \\
...
![Ratio of reserved cars to expected failures, decreasing as the fleet grows]({{ '/assets/images/image-LLN-cars-ratio.png' | relative_url }})
